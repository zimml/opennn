...
/// Default constructor.
/// It creates a gradient descent optimization algorithm not associated with any
/// loss index object. It also initializes the class members to their default
/// values.

GradientDescent::GradientDescent() : OptimizationAlgorithm()
{
	set_default();
}

/// Loss index constructor.
/// It creates a gradient descent optimization algorithm associated with a loss
/// index. It also initializes the class members to their default values.
...
const LearningRateAlgorithm& GradientDescent::get_learning_rate_algorithm()
	const
{
	return learning_rate_algorithm;
}

/// Returns a pointer to the learning rate algorithm object inside the gradient
/// descent object.
...
void GradientDescent::set_maximum_epochs_number(
...
void GradientDescent::set_minimum_loss_decrease(
...
void GradientDescent::set_maximum_selection_failures(
...
void GradientDescent::calculate_training_direction(
	const Tensor<type, 1>& gradient, Tensor<type, 1>& training_direction) const
{
	...
	{
		buffer << "OpenNN Exception: GradientDescent class.\n"
			   << "Tensor<type, 1> calculate_training_direction(const "
	...
	GradientDescentData& optimization_data) const
{
	...
	calculate_training_direction(back_propagation.gradient,
